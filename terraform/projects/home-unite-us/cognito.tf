...
resource "aws_lambda_function" "cognito_custom_message" {
  ...
  function_name = "${local.project_name}-customMessage"
...
resource "aws_lambda_function" "cognito_merge_users" {
  ...
  function_name = "${local.project_name}-mergeUsers"
  role          = aws_iam_role.lambda.arn
...
resource "aws_cognito_user_pool_client" "homeuniteus" {
  ...
  callback_urls = [
    ...
    "https://qa1.homeunite.us/signin",
    "https://qa1.homeunite.us/signup",
    "https://qa1.homeunite.us/signup/coordinator",
    "https://qa1.homeunite.us/signup/host"
  ]
